...
# Note: This script should be run from the src/ directory
# The relative paths assume execution from /root/autodl-tmp/KSHL-PC/src/
...
model = torch.load('KSHL-PC_model.pt')
X = torch.load('protein_feature_SHE.pt')
